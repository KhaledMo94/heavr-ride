                    ...
                    <tbody>
                        ...
                        @foreach ($orders as $order)
                            <tr data-id="{{ $order->id }}">
                                <td>{{ ++$i }}</td>
                                <td>{{ $order->uuid }}</td>
                                <td>{{ $order->service?->getTranslation('name',app()->getLocale()) ?? $order->getTranslation('service_name',app()->getLocale()) }}</td>
                                <td>{{ __($order->serviceProviderBranch->getTranslation('name',app()->getLocale())) ?? __($order->getTranslation('service_provider_branch_address',app()->getLocale())) }}</td>
