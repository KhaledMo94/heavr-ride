                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5 text-center">
                                ...
                                <h1 class="mb-4 text-gray-900 h4">{{ __('Reset Password') }}</h1>
                                <p class="text-muted mb-4">{{ __('Enter your new password below to reset your account.') }}</p>
                                ...
                                <form method="POST" action="{{ route('password.store') }}" class="user">
                                    ...
                                    <div class="form-group text-start">
                                        <label for="password" class="small text-gray-700">{{ __('New Password') }}</label>
                                        <input id="password" type="password" class="form-control form-control-user"
                                            name="password" required placeholder="{{ __('Enter new password') }}">
                                        @error('password')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group text-start">
                                        <label for="password_confirmation" class="small text-gray-700">{{ __('Confirm Password') }}</label>
                                        <input id="password_confirmation" type="password" class="form-control form-control-user"
                                            name="password_confirmation" required placeholder="{{ __('Confirm your new password') }}">
                                    ...
                                    <button type="submit"
                                        class="btn btn-quickdiscount btn-user btn-block">{{ __('Reset Password') }}</button>
                                </form>
